 ...
 * {@link android.view.View#setBackground(android.graphics.drawable.Drawable) background}
 * property of its target views (when the background is a
 * {@link android.graphics.drawable.ColorDrawable}, as well as the
 * {@link android.widget.TextView#setTextColor(android.content.res.ColorStateList)
